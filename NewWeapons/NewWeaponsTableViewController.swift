...
//    var favorites = Array(repeating: false, count: 11)
    ...
    var weapons = [
        Weapon(name: "AUG", type: "自动步枪", origin: "奥地利", image: "aug", favorite: false, bullet: 7.62, mv: 900, text: """
...
""") ,
        Weapon(name: "AWM", type: "狙击枪", origin: "英国", image: "awm", favorite: false, bullet: 0.3, mv: 910, text: """
...
""") ,
        Weapon(name: "十字弩", type: "冷兵器", origin: "中国", image: "crossbow", favorite: false, bullet: 0.0, mv: 160, text: """
...
""") ,
        Weapon(name: "DP28", type: "机枪", origin: "前苏联", image: "dp28", favorite: false, bullet: 5.56, mv: 700, text: """
...
""") ,
        Weapon(name: "Groza", type: "自动步枪", origin: "俄罗斯", image: "groza", favorite: false, bullet: 7.62, mv: 715, text: """
...
缺点：空投出品，比较稀少，远距离乏力。
""") ,
        Weapon(name: "Kar98k", type: "狙击枪", origin: "德国", image: "kar98k", favorite: false, bullet: 7.62, mv: 760, text: """
...
枪托类：98k子弹袋、狙击枪托腮板
""") ,
        Weapon(name: "M16a4", type: "自动步枪", origin: "美国", image: "m16a4", favorite: false, bullet: 5.56, mv: 900, text: """
...
""") ,
        Weapon(name: "Micro UZI", type: "冲锋枪", origin: "以色列", image: "microuzi", favorite: false, bullet: 9.0, mv: 350, text: """
...
""") ,
        Weapon(name: "平底锅", type: "厨具", origin: "美国", image: "pan", favorite: false, bullet: 0.0, mv: 0, text: """
...
如果放砍刀和棍子，都会显得有些尴尬，锅是性价比最好的道具了。
""") ,
        Weapon(name: "SKS", type: "半自动步枪", origin: "前苏联", image: "sks", favorite: false, bullet: 7.62, mv: 800, text: """
...
""") ,
        Weapon(name: "UMP9", type: "冲锋枪", origin: "美国", image: "ump9", favorite: false, bullet: 7.62, mv: 750, text: """
...
//        cell.favorite = favorites[indexPath.row]
        cell.nameLabel.text = weapons[indexPath.row].name
        cell.typeLabel.text = weapons[indexPath.row].type
        cell.addressLabel.text = weapons[indexPath.row].origin
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if (segue.identifier == "showWeaponDetail") {
            ...
            destination.thisWeapon = weapons[row]
        }
    }
